...
class rex_yform_value_uppy extends rex_yform_value_abstract
{
    ...
    public function enterObject()
    {
        ...
        if ($this->needsOutput()) {
            $this->params['form_output'][$this->getId()] = $this->parse('value.uppy.tpl.php', compact('counter'));
        }
    ...
    public function getDefinitions()
    {
        return [
            ...
            'values' => [
                ...
                'required' => ['type' => 'boolean', 'label' => rex_i18n::msg('yform_values_uppy_required')],
